...
names(Direct_indirect_methylation_up) <- c("IDH1_in_Responder", "IDH1_in_Non_responder", "Non_responder_in_IDH2", "Non_responder_in_IDH1")
...
names(Direct_indirect_methylation_down) <- c("IDH2_in_Responder", "IDH2_in_Non_responder", "Responder_in_IDH2", "Responder_in_IDH1")
