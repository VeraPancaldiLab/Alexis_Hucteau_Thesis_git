...
```{r}
List_IDs <- list("IDH1_vs_IDHwt" = Direct_indirect_methylation$`Molm_1-Molm_wt`, 
                 "IDH2_vs_IDHwt" = Direct_indirect_methylation$`Molm_2-Molm_wt`, 
                 "IDH1_vs_IDH2" = Direct_indirect_methylation$`Molm_1-Molm_2`,
                 "IDH2_vs_IDH1" = Direct_indirect_methylation$`Molm_2-Molm_1`
                 )
```
