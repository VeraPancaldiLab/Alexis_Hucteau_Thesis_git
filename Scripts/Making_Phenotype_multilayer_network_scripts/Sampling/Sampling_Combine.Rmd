...
Layers_All_links_multi_layer_intra_scaled <- lapply(1:3, function(layer){
...
```{r}
Layer_1_interlayered_odd <- mclapply(seq(1,20, by = 2), function(sampling){
  res <- Create_Custom_Inter_layer_links(Layers_All_links_multi_layer_intra_scaled[["Layer_1"]][[sampling]], layer_1_dataconversion, 1)
  res <- Create_Custom_Inter_layer_links(res, layer_4_dataconversion, 4)
  res
}, mc.cores = 2)
```
